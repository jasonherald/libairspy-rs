...
//!
//! The fixtures live at the workspace root and are not shipped in the
//! published package (456 KB of data with no runtime role), so these
//! tests require the repository checkout; `cargo test` from an
//! unpacked crates.io package is not a supported workflow.
